...
const Sidebar = () => {
  ...
  const filteredSidebar = SidebarDataTest.filter((menu: any) => {
    if (role === "admin" || role === "hr") return true;
    return menu.tittle === "Main Menu"; // employee → only main menu
  });
          ...
          <div className="d-flex align-items-center justify-content-between menu-item mb-3">
            <div className="me-3">
              <Link to="#" className="btn btn-menubar position-relative">
                ...
                <span className="badge bg-success rounded-pill d-flex align-items-center justify-content-center header-badge">5</span>
              </Link>
            </div>
            <div className="me-3">
